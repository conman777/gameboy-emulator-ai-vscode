// GameAIConsole.tsx - A dedicated console to display AI thoughts and allow direct interaction
...
const GameAIConsole: React.FC<GameAIConsoleProps> = ({ 
  isActive, 
  onSendPrompt, 
  aiThought, 
  lastAction 
