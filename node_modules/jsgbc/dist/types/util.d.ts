...
export declare function concatArrayBuffers(...buffers: any[]): ArrayBufferLike;
...
export declare function readFirstMatchingExtension(blob: Blob, filename: string, extensions: string[]): Promise<ArrayBuffer>;
export declare function hasExtension(filename: string, extension: string): boolean;
export declare function debounce(func: any, wait: number): Debounced;
